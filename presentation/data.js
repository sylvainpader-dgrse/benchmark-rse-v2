  ...
  rapports: [
    {
      ...
      idees: [
        ...
        { titre: "Charte d'engagement territorial signée avec les collectivités de nos campus",
          pourquoi: "ESSEC a signé en juin 2023 la charte territoriale de la Communauté d'Agglomération de Cergy-Pontoise — un engagement formel et public sur la transition écologique et sociale du territoire. Chez nous, on a des partenariats locaux (Plan Écowatt, etc.) mais pas de charte territoriale signée publiquement avec les collectivités où nos campus sont implantés.",
          comment: "Identifier les collectivités de nos campus (Nanterre, Lyon, etc.) et proposer la signature d'une charte d'engagement réciproque : nos engagements RSE locaux + leurs engagements pour faciliter notre transition. Médiatiser la signature." },
        { titre: "Bourse / forfait mobilité bas-carbone pour les apprenants",
          pourquoi: "ESSEC offre des Sustainable Mobility Vouchers : bourse financière pour les étudiants choisissant le transport bas-carbone pour leurs stages et échanges internationaux (45 bénéficiaires 23/24). Chez nous : partenariat Karos covoiturage = passif, pas d'incitation financière à choisir le bas-carbone.",
          comment: "Créer un forfait mobilité durable : prise en charge partielle des billets de train (vs avion) pour stages / échanges des apprenants. Critère d'éligibilité : trajet < 6h en train ou destination accessible sans avion." },
        { titre: "Concours / appels à projets RSE étudiants avec récompense financière",
          pourquoi: "ESSEC organise le concours « Reinvent Your Mobility » avec l'asso étudiante NOISE : projets de mobilité durable récompensés jusqu'à 2 000 €. Résultat 2024 : 2 étudiants traversent 18 pays européens sans avion. Chez nous : pas de concours / appels à projets RSE étudiants avec dotation.",
          comment: "Lancer un appel à projets RSE étudiants annuel (mobilité, biodiversité, inclusion, frugalité numérique) avec dotation 1 500-3 000 €. Co-construit avec une asso étudiante. Communiquer les lauréats dans le rapport." },
      ],
    },
    {
