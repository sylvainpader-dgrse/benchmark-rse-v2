  ...
  rapports: [
    ...
    },
    {
      ...
      forme_plus: [
        ...
        "Format magazine : illustrations originales pleine page + photos + verbatims nombreux",
        "Couleurs distinctives par chapitre (Recherche, Éducation, Campus, Diversité & Inclusion)",
        "Page d'ouverture de chaque grande partie : Ambition narrative + Indicateur cible + chiffre phare",
        "Carte d'identité p.4-5 : chiffres clés à gauche + labels d'engagement à droite",
        "Page « Témoignages » p.8 avec 6 voix variées",
        "Bilan carbone visuel double angle scope + poste sur la même page p.28",
        "Encadré « Nos prestataires engagés » : 5 fournisseurs en mini-fiches p.26",
      ],
      forme_moins: [
      ...
      fond_plus: [
        "Plan « Impact Future Generations 2025 » avec 5 piliers DDRS (Transversal, Campus, Éducation, Recherche, Diversité & Inclusion)",
        "Signature « Make an Impact » et raison d'être : créer un impact positif sur le monde",
        "Matrice de matérialité réalisée avec Capgemini Invent en 2022",
        "Audit interne 2020 + Capgemini 2022 : 280+ initiatives DDRS recensées",
        "Poste Responsable RSE créé en 2022 + Comité de référents par département",
        "Ethics Board depuis 2011 (rôle RSE élargi)",
        "EDHEC-Risk Climate Impact Institute : 20 M€ sur 4 ans, 25 personnes, finance climatique",
        "25 % des publications académiques sur enjeux RSE en 2022-2023 (× 2 vs 2020)",
        "35 nouveaux professeurs profils RSE recrutés depuis 2019",
        "Chaires alignées RSE : Diversité & Inclusion 2016, Scientific Beta (ESG / greenwashing), EDHECinfra (Green Infrastructures)",
        ...
        "Sustainable Impact Projects BBA depuis 2021 (liés aux 17 ODD) + Global Impact Projects (ONG internationales)",
        "100 % des startups EDHEC formées à l'entrepreneuriat responsable (objectif 300 d'ici 2030)",
        "Centre for Responsible Entrepreneurship + livre blanc sur 200 startups + méthode « Responsible Entrepreneurship by design »",
        "Bilan carbone 2022 (1ère mesure) tous scopes : 83 % scope 3, déplacements 64,3 %",
        "Trajectoire chiffrée : -40 % GES scope 1+2 et -20 % scope 3 d'ici 2030, neutralité 2050",
        "Suivi bilan carbone tous les 2 ans",
        "Plan Share & Care Campus en 4 axes (carbone, alimentation, biodiversité, inclusion)",
        "Électricité 100 % bas carbone sur tous les campus",
        "Politique Green IT (durée de vie matériel 5 ans, Eco Label, partenariat ATF Gaia)",
        "10 ha parc arboré (490 arbres, 4 ruches, 3 hôtels à insectes, sans pesticides)",
        "Prestataires engagés explicités : API Restauration (entreprise à mission), 1001 Feuilles, Lemon Tri, Beesk, ATF Gaia",
        "Programme EDHEC For All : bourses jusqu'à 75 % frais scolarité pour 1 300 élèves/an (10 M€)",
        "EDHEC Talents (lycéens boursiers Lille, 2023) + Talents Prépa (depuis 2022)",
        "Chaire Diversité & Inclusion (2016) : jeu de cartes VSS + concours d'affiches étudiantes",
        "Plateforme signalement VSS + réseau étudiants sentinelles + journée VSS obligatoire à chaque rentrée",
        "47 % de présidentes dans les associations étudiantes",
        "Formation RSO des associations (coaching mensuel depuis 2020) : 2/3 ont un rapport RSO formalisé",
        "EDHEC Vox : portail de diffusion de la recherche vers le grand public",
        "230 M€ investissement horizon 2025",
      ],
      fond_moins: [
        "Bilan carbone tous les 2 ans (vs annuel ailleurs)",
