...
const PRESENTATION_DATA = {
  ...
  rapports: [
    ...
    },
    {
      ...
      forme_plus: [
        "Tableau de progression p.8-10 avec niveau de maturité en jauge visuelle",
        "Schéma de gouvernance multi-niveaux p.11 avec code couleur par catégorie",
        "Code couleur par grande partie (Formation rouge, Recherche violet, Fonctionnement or)",
        "Encadré « Notre action en chiffres » en fin de chaque sous-partie",
        "Encadré « Les défis à relever » en fin de chaque grande partie",
        "Pages « Focus » dédiées (rentrée ODD 11, nouveau campus de Lyon)",
        "Couverture rouge identitaire avec tampon « Société à Mission »",
      ],
      forme_moins: [
        "3 pages séparatrices quasi-vierges (p.13, p.21, p.27)",
      ...
      fond_plus: [
        "Statut juridique Société à Mission depuis 2021 (cadre opposable inscrit dans les statuts)",
        "10 objectifs statutaires : 4 Formation, 3 Recherche, 3 Fonctionnement",
        "Plan Résonances 2028 qui décline les 10 objectifs en cibles 2028",
        "Comité de Mission 9 personnes dont 6 externes (vérification indépendante)",
        "Organisme Tiers Indépendant accrédité COFRAC pour vérifier l'atteinte des objectifs",
        "Direction Engagement Social et Environnemental au Comité Exécutif (13 collaborateurs + 7 médico-sociaux)",
        "30 ambassadeurs collaborateurs + 1 référent RSE par association étudiante (33 assos)",
        "Référentiel propriétaire SDGs Inside : 34 compétences RSE / 17 ODD analysant 90 % des cours",
        "Programme d'Engagement Responsable obligatoire PGE : 50 h bénévolat, 1 612 engagements, 87 300 h, 86 associations",
        "Rentrée 2024 ODD 11 : 3 300 étudiants, 150 maraudes, 300 cleanwalks, 1 000 sensibilisés gaspi, 2 000 lettres seniors",
        "4 chaires recherche alignées mission : Carbone 4, Malakoff, Groupama, Vinci/Centrale Lyon",
        "Nouveau campus Gerland (sept 2024) labels HQE + BREEAM + Osmoz + R2S, 380 vélos, 0 parking auto",
        "Train obligatoire < 6 h pour collaborateurs + Pass Betterway 400 €/an + programme Pro Vélo",
        "Charte d'engagement RSE signée par les 33 associations étudiantes (label interne Ecollab)",
        "Programme « la toile » 100 % gratuit : 400 apprenants, 82 % sortie positive, 90 % certification",
        "219 étudiants handicap accompagnés (+ 135 % depuis 2021), 87 % satisfaits",
        "Fondation INFINITE : prêts à taux zéro 20-45 K€ par étudiant boursier",
        "Index égalité 89/100 (+ 5 pts depuis 2021), 47 % femmes CoDir, 36 % Comex",
        "Charte LGBT+ Autre Cercle 2022 + baromètre interne 77 % perception inclusive",
        "Labellisation HRS4R (Human Resource Strategy for Researchers) février 2025",
        "Classement FT : 3e mondial et 1re française sur « ESG and net zero teaching »",
      ],
      fond_moins: [
