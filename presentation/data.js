  ...
  rapports: [
    {
      ...
      idees: [
        { titre: "Présenter nos indicateurs environnementaux en variation (delta vs année de base)",
          pourquoi: "ESSEC affiche « -10% empreinte CO2/étudiant », « +1.9× recyclage », « -30% déchets » vs 18/19. Le delta rend la dynamique visible immédiatement, mieux qu'un chiffre brut.",
          comment: "Sur chaque KPI environnemental (BC, conso énergie, déchets, déplacements) : afficher la valeur N + le delta vs notre première mesure 2024-2025 (base 100). À partir du prochain rapport (N+1 vs N). Visuel type pictogramme + chiffre + flèche." },
        { titre: "Viser un rapport plus court et plus dense (22-30 p. au lieu de 48 p.)",
          pourquoi: "ESSEC condense l'essentiel sur 22 p. très denses et mémorables. Au-delà de 40-50 p., le lecteur décroche. Un rapport plus court force la hiérarchisation et l'arbitrage.",
          comment: "Cibler ~30 p. pour le prochain rapport (vs 48). Réduire les pages de transition, fusionner les sous-sections, privilégier les schémas/KPI sur les paragraphes longs. Renvoyer le détail vers une annexe web si besoin." },
      ],
    },
    {
