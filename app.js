      ...
      <div class="pres-analysis">
        ...
        <div class="pres-block pres-fond">
          ...
          <ul>
            ...
            <li><strong>Dimension Groupe sous-exploitée</strong> : deux leviers manquent. (1) Aucun encadré « Mais aussi… dans les écoles du Groupe » qui valorise, en bullets courts, les initiatives propres à chaque école (un projet associatif phare, une action environnementale locale, un partenariat de territoire, un dispositif handicap spécifique). (2) Aucun indicateur consolidé exprimé en pourcentage d'écoles ayant déployé telle ou telle action. AD Education (19 écoles) et Galileo (64 écoles) ont tous deux trouvé cette solution éditoriale pour matérialiser que la démarche RSE infuse dans toutes les écoles, et pas uniquement au siège du Groupe, sans alourdir le récit principal.</li>
          </ul>
        </div>
      </div>
    </section>
