...
TARGETS = [
    ...
    ('kedge_inner3.jpg',  7,  "p.14-15 — Indicateurs clés : 14 KPIs structurés par 5 axes (Stratégie, Politique sociale, Enseignement, Gestion environnementale, Recherche) avec flèches d'évolution vs 2019"),
    ('kedge_inner4.jpg',  8,  "p.16-17 — Timeline « Un engagement à long terme » : 17 ans d'engagement (2005-2021) avec ~32 jalons (créations Sulitest, HESI, chaires, dispositifs)"),
]
