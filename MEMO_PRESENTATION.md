...
- **Idées hors scope rapport** (cas ESSEC, 12 mai) : les idées doivent porter sur la **forme** et le **fond éditorial du rapport** — pas sur la création de nouveaux programmes opérationnels chez IGENSIA. Une charte territoriale, une bourse mobilité, un concours étudiant sont des programmes OPÉRATIONNELS d'ESSEC : ils restent dans `fond_plus` (description de ce qu'ils ont) mais ne deviennent pas des idées pour notre rapport. Les idées doivent être actionnables par les rédacteurs du prochain rapport, pas par la direction RSE qui lance des programmes.
...
- ESSEC (#2) : 2 idées vraies (Chiffres clés en encadré par chapitre, indicateurs en variation), 1 forme_plus, 12 fond_plus. Beaucoup d'éléments dropés car équivalents à ce qu'on a déjà (frise, schéma gouvernance, codification RÉALISÉ/LANCÉ/PRÉVU, témoignages variés, hiérarchie typo, densité éditoriale, réseau ambassadeurs RSE). Plusieurs dispositifs distinctifs d'ESSEC (charte territoriale, bourse mobilité, concours étudiants, PQPM, charte LGBT+) restent en fond_plus mais ne deviennent pas des idées car ce sont des **programmes opérationnels**, pas des recommandations éditoriales pour notre prochain rapport. Insight 1 : la page Témoignages dédiée d'ESSEC est en fait un **point faible** par rapport à notre approche de témoignages incarnés au fil des sections. Insight 2 : il faut **creuser au-delà des grandes catégories visibles** pour identifier ce qui est distinctif. Insight 3 : **scope strict** des idées = rapport (forme + fond éditorial), pas opérationnel.
